...
- 🐳 Deploy with this image: `kimaraai/runpod-worker-comfy:1.0.2-base`
...
- Available images:
  - `kimaraai/runpod-worker-comfy:1.0.2-base`: Clean ComfyUI without models
...
- Configure:
  ...
  - Type: serverless
  - Image: `kimaraai/runpod-worker-comfy:1.0.2-base`
  - Disk: `20 GB`
